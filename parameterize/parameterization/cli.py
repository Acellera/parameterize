...
def _prepare_molecule(args):
    ...
    from parameterize.parameterization.fixes import fixPhosphateTypes
...
def _output_results(mol, parameters, original_coords, args):
    ...
    from parameterize.parameterization.writers import writeParameters
...
def main_parameterize(arguments=None, progress=None):
    ...
    from parameterize.parameterization.parameterset import (
        recreateParameters,
    ...
    if args.min_type != "None":
        ...
        mm_minimizer = None
        if args.min_type == "mm":
            from parameterize.qm.custom import OMMMinimizer
    ...
    if len(selected_dihedrals) > 0:
        ...
        from parameterize.parameterization.dihedral import DihedralFitting  # Slow import
